        ...
        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            <div class="grid grid-cols-6 gap-6" x-data="{ cc: false}">
                ...
                <div class="lg:col-span-3 md:col-span-5 sm:col-span-5">
                    ...
                    <select class="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" wire:model="outgoing.destination_id">
                ...
                <div class="col-span-6" x-show="cc">
                    ...
                    <x-select-list class="form-control" required id="destinations" name="destinations" :options="$listDestinations" multiple wire:model="destinations"/>
                </div>
