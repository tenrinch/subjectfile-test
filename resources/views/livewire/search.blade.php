<div x-data="{ advance_filter: false }">
    <div class="flex bodyig mx-auto items-end justify-center">
        <div class="relative rounded-md shadow-sm w-10/12">
            ...
            <input type="text" name="price" id="price" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-12 pr-4 sm:text-sm border-gray-300 rounded-md py-2 md:text-lg py-2" placeholder="གནད་དོན།" wire:model.defer = "subject">
