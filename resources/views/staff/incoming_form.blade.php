<div class="px-4 py-5 bg-white space-y-6 sm:p-6">
    ...
    <div class="grid grid-cols-6 gap-6">
        ...
        <div class="lg:col-span-2 md:col-span-3 sm:col-span-6">
            ...
            <select class="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" wire:model="incoming.department_id">
